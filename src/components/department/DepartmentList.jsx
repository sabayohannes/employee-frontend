...
const DepartmentList = () => {
  ...
  useEffect(() => {
    const fetchDepartments = async () => {
      setDepLoading(true)
      try {
        const response = await axios.get("https://employee-api-theta.vercel.app/api/department", {
          headers: {
...
setFilteredDepartments(records);
  ...
  return (
    <div>{depLoading ? <div>Loading</div> :
      <div className='p-5'>
        ...
        <div className='mt-5'><DataTable columns={columns} data={filteredDepartments} pagination/></div>
