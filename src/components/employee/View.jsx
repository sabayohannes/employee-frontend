...
const View = () => {
    ...
    useEffect(() => { 
        const fetchEmployee = async () => {
            ...
            try {
                const response = await axios.get(`https://employee-api-theta.vercel.app/api/employee/${id}`, {
                    headers: {
 ...
 <>   {employee ?( 
    <div>
      <div><img src={`https://employee-api-theta.vercel.app/${employee.userId.profileImage}`} className='rounded-full border w-72'/></div>
