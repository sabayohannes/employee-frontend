...
try{
 const response= await axios.post("https://employee-api-theta.vercel.app/api/auth/login",{email,password});
  ...
  return (
    ...
    from-50% to-gray-100% to 50% space-y-6'>
      ...
      <form onSubmit={handleSubmit}>
       ...
       <label><input type='checkbox' className='form-checkbox' htmlFor='Remember me'/>
       <span className='ml-2 text-gray-700'>Remember me </span></label>
      <a href='#' className='text-teal-600'>Forgot password</a>
   </div>
   <div className='mb-4'>  
    <button type='submit' className='w-full bg-teal-600 text-white py-2'>Login</button></div>
